      ...
      <PerfectScrollbar className="deznav-scroll">
        <MM className="metismenu" id="menu">
          ...
          <Link className="has-arrow ai-icon" to="#" >
            ...
            <ul >
            <li><Link className={`${path === "" ? "mm-active" : "clienti"}`} to="/clienti"> Tutti i clienti</Link></li>
              <li><Link className={`${path === "richieste" ? "mm-active" : ""}`} to="/richieste">Richieste</Link></li>
              <li>
                <Link className={`${path === "acquirenti" ? "mm-active" : ""}`} to="/acquirenti"> 
                  Acquirenti
                </Link>
              </li>
              <li><Link className={`${path === "venditori" ? "mm-active" : ""}`} to="/venditori">Venditori</Link></li>
            </ul>
          </li>

          <li className={`${properties.includes(path) ? "mm-active" : ""}`}>
          <Link className="has-arrow ai-icon" to="/#" >
              <i className="flaticon-047-home"></i>
              <span className="nav-text">Immobili</span>
            </Link>
            <ul >
            <li><Link className={`${path === "" ? "mm-active" : "immobili"}`} to="/immobili"> Tutti gli immobili</Link></li>
              <li><Link className={`${path === "vendita" ? "mm-active" : ""}`} to="/vendita">In vendita</Link></li>
              <li>
                <Link className={`${path === "affitto" ? "mm-active" : ""}`} to="/affitto"> 
                  In affitto
                </Link>
                <li><Link className={`${path === "incrocia" ? "mm-active" : ""}`} to="/incrocia">Incrocia dati</Link></li>
              </li>
              <li><Link className={`${path === "trattative" ? "mm-active" : ""}`} to="/trattative">Trattative</Link></li>
            </ul>
          </li>

          <li className={`${agency.includes(path) ? "mm-active" : ""}`}>
          <Link className="has-arrow ai-icon" to="/#" >
              <i className="flaticon-024-dashboard"></i>
              <span className="nav-text">Agenzia</span>
            </Link>
            <ul >
            <li><Link className={`${path === "" ? "mm-active" : "agenzia"}`} to="/agenzia"> Dashboard Agenzia</Link></li>
              <li><Link className={`${path === "storico" ? "mm-active" : ""}`} to="/storico">Storico</Link></li>
              <li>
                <Link className={`${path === "agenti" ? "mm-active" : ""}`} to="/agenti"> 
                  Agenti
                </Link>
                <li><Link className={`${path === "collaboratori" ? "mm-active" : ""}`} to="/collaboratori">Collaboratori</Link></li>
              </li>
            </ul>
          </li>
          ...
          <li className={`${deshBoard.includes(path) ? "mm-active" : ""}`}>
            ...
            <ul >
              ...
              <li><Link className={`${path === "order-list" ? "mm-active" : ""}`} to="/order-list">Order List</Link></li>
              <li><Link className={`${path === "property-details" ? "mm-active" : ""}`} to="/property-details">Property Details</Link></li>
              <li><Link className={`${path === "customer-list" ? "mm-active" : ""}`} to="/customer-list">Customers</Link></li>
