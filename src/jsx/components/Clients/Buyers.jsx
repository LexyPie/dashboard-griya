...
export default function Buyers() {
  ...
  return (
    <>
      <div>Hello world Acquirenti</div>

      <PageHead activePage="Acquirenti" pageName="Clienti" />
      <div className="row contacts-list-area">
        <div className="col-xl-12">
          <div className="d-flex flex-wrap">
            <Link to={"#"} className="btn btn-primary me-3 mb-3">+New Transactions</Link>
            ...
            <Link to={"#"} className="btn btn-primary me-3 mb-3"><i className="fas fa-calendar me-3"></i>Filtra</Link>
