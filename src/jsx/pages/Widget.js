    ...
    <Fragment>
      ...
      <div className="row">
        <div className="col-xl-4 col-xxl-6 col-lg-6">
          <div className="card">
            <div className="card-header borend pb-0">
        ...
        <div className="col-xl-4 col-xxl-6 col-lg-6">
          <div className="card borend pb-0">
            <div className="card-header borend pb-0">
        ...
        <div className="col-xl-12 col-lg-12 col-sm-12">
          <div className="row">
            <div className="col-xl-3 col-lg-6 col-sm-6">
              <div className="widget-stat card bg-primary">
                <div className="card-header borend ">
            ...
            <div className="col-xl-3 col-lg-6 col-sm-6">
              <div className="widget-stat card bg-secondary">
                <div className="card-header pb-3 borend pb-0">
        ...
        <div className="col-xl-8 col-xxl-8 col-lg-12 col-sm-12">
          <div id="user-activity" className="card">
            <Tab.Container defaultActiveKey="day">
              <div className="card-header borend pb-0 d-sm-flex d-block">
        ...
        <div className="col-xl-4 col-lg-6 col-sm-6">
          <div className="card active_users">
            <div className="card-header bg-secondary borend d-block pb-0">
              <h4 className="card-title text-white">Active Users</h4>
              <ActiveUser />
            </div>
            <div className="card-body pt-0">
              <div className="list-group-flush mt-4">
                <div className="list-group-item bg-transparent d-flex justify-content-between px-0 py-1 font-weight-semi-bold bordeend-0">
        ...
        <div className="col-xl-4 col-lg-12 col-sm-12">
          <div className="card overflow-hidden">
            ...
            <div className="card-footer borend mt-0">
